...
export const PRODUCT_SMARTPHONE_LIST: ProductItem[] = [
  ...
  },
  {
    ...
    description:
      "スマートで、パワフル、便利な機能。すべてが詰まってお手ごろ価格。",
    detail: "",
    price: 53900,
    image: Pixel6aImg,
    quantity: 1,
...
export const PRODUCT_SMARTWATCH_LIST: ProductItem[] = [
  {
    ...
    description:
      "Google の便利な機能を利用しながら、Fitbit で健康的な生活を手に入れましょう。",
    detail: "",
    price: 39800,
    image: PixelWatchImg,
    quantity: 1,
...
export const ALL_PRODUCT_LIST = [
  ...PRODUCT_SMARTPHONE_LIST,
  ...PRODUCT_SMARTWATCH_LIST,
];
